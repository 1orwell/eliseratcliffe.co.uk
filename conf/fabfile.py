...
env.project = 'eliseratcliffe.co.uk'
...
def server():
    ...
    env.rk_remote_path = '/home/redkestrel/projects/eliseratcliffe.co.uk/' 

    # path to the cc directory on the local server. 
    env.rk_local_path = '~/projects/eliseratcliffe.co.uk/'
...
def sync():
    ...
    puts(_green_bg('Synching eliseratcliffe.co.uk'))
